...
routes['POST']['/books/create'] ='Books#add_book_review'
routes['GET']['/books/<int:id>'] = 'Books#book_detail'
routes['GET']['/users/<int:id>'] = 'Users#user_detail'
routes['GET']['/books/delete/<int:id>'] = 'Books#confirm_delete'
routes['POST']['/books/<id>'] = 'Books#review_delete'
routes['GET']['/users/edit/<int:id>'] = 'Users#get_user_details'
routes['POST']['/users/<int:id>'] = 'Users#edit_user_details'
"""
